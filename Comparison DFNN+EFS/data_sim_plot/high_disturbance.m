...
winsize=[0.1,0.1,0.6,0.7];zihao=25;lw=2;xysize=[0.13,0.13,0.8,0.8];
...
%         print(fig,['e',num2str(i),'_high.emf'],'-r400','-dmeta'); % 设置图片格式、分辨率
end
%%
...
%     print(fig,['iae_mean','_high.emf'],'-r400','-dmeta'); % 保存图片
